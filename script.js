document.addEventListener('DOMContentLoaded', function () {
  ...
  function revealOnScroll() {
    const elements = document.querySelectorAll('.' + ANIMATION_CLASS + ':not(.' + VISIBLE_CLASS + ')');
  ...
  if ('IntersectionObserver' in window) {
    ...
    document.querySelectorAll('.' + ANIMATION_CLASS).forEach(function (el) {
      observer.observe(el);
    });
  } else {
    revealOnScroll();
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "התאמה חכמה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '5a7d1d06-a00a-4271-a125-0251827a7f37',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '5a7d1d06-a00a-4271-a125-0251827a7f37';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5a7d1d06-a00a-4271-a125-0251827a7f37';
